const IconFem = () => {
  return (
    <svg
      ...
      viewBox="0 0 26 23"
      fill="none"
      className="[width:19px] sm:w-6 sm:h-6 fill-white hover:fill-green"
      role="img"
      aria-describedby="fem"
    >
      <title id="fem">Adam Keyes Frontend Mentor Page Link</title>
      <path
        // fill="#FFF"
        // fillRule="evenodd"
