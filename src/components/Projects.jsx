...
const Projects = () => {
  return (
    <section className="px-4 sm:mb-28">
      ...
      <ul
        role="list"
        className="pl-0 flex flex-col items-center sm:grid sm:grid-row-3 sm:grid-col-2 sm:gap-x-5 sm:gap-y-45"
      >
        <li
          role="listitem"
          className="mb-10 sm:col-end-2 sm:row-start-1 sm:mb-0"
        >
          ...
          <h3 className="uppercase text-2xl mb-3">Design Portfolio</h3>
